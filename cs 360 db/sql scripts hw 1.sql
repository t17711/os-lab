...
show indexes in F16336btimalsi.authors;

show tables;
show CREATE table salesdetail; /* to see how tables are created*/
describe salesdetail;  /* describes keys */
/* add tablees */
...
insert salesdetail values ('5023', 'BS-345-DSE-860-1F2', 'PC1035', 1000, 46.7 );
 
insert salesdetail values ('5023', 'AX-532-FED-452-2Z7', 'BU2075', 500, 46.7 );
 
insert salesdetail values ('5023', 'AX-532-FED-452-2Z7', 'BU1032', 200, 46.7 );
 
insert salesdetail values ('5023', 'AX-532-FED-452-2Z7', 'BU7832', 150, 46.7 );
 
insert salesdetail values ('5023', 'AX-532-FED-452-2Z7', 'PS7777', 125, 46.7 );
 
insert salesdetail values ('5023', 'NF-123-ADS-642-9G3', 'TC7777', 1000, 46.7 );
 
insert salesdetail values ('5023', 'NF-123-ADS-642-9G3', 'BU1032', 1000, 46.7 );
 
insert salesdetail values ('5023', 'NF-123-ADS-642-9G3', 'PC1035', 750, 46.7 );
...
insert salesdetail values ('5023', 'ZD-123-DFG-752-9G8', 'PS2091', 1000, 46.7 );
...
insert salesdetail values ('5023', 'XS-135-DER-432-8J2', 'PS2091', 845, 46.7 );
 
insert salesdetail values ('5023', 'XS-135-DER-432-8J2', 'PS7777', 581, 46.7 );
 
insert salesdetail values ('5023', 'ZZ-999-ZZZ-999-0A0', 'PS1372', 375, 46.7 );
 
insert salesdetail values ('7067', 'NB-3.142', 'BU1111', 175, 46.7 );
 
insert salesdetail values ('5023', 'XS-135-DER-432-8J2', 'BU7832', 885, 46.7 );
 
insert salesdetail values ('5023', 'ZD-123-DFG-752-9G8', 'BU7832', 900, 46.7 );
 
insert salesdetail values ('5023', 'AX-532-FED-452-2Z7', 'TC4203', 550, 46.7 );
...
insert salesdetail values ('5023', 'AX-532-FED-452-2Z7', 'PC8888', 105, 46.7 );
 
insert salesdetail values ('5023', 'NF-123-ADS-642-9G3', 'PC8888', 300, 46.7 );
...
insert salesdetail values ('5023', 'AX-532-FED-452-2Z7', 'BU1111', 370, 46.7 );
 
insert salesdetail values ('5023', 'ZD-123-DFG-752-9G8', 'PS3333', 750, 46.7 );
...
insert salesdetail values ('5023', 'ZA-000-ASD-324-4D1', 'MC3021', 3000, 50 );
...
insert salesdetail values ('5023', 'AB-123-DEF-425-1Z3', 'TC4203', 2500, 60.5 );
 
insert salesdetail values ('5023', 'AB-123-DEF-425-1Z3', 'BU2075', 4000, 60.5 );
...
'Traditional French  urmet recipes adapted for modern microwave cooking.',
'06/18/85', 1 );
...
insert discounts
values('Initial Customer', '5023', NULL, NULL, 10.5 );
 
insert discounts 
values('Volume Discount', '7066', 100, 1000, 6.7 );
 
insert discounts
values('Huge Volume Discount', '7131', 1001, NULL, 10 );
...
/* this sets the default value of type to undecided if not set before*/
create unique index pubind on publishers (pub_id);
/*all row of pub_id must be unique, index sets the value as key, unique index is unique key */
...
/* example -> SELECT * FROM titleauthor use INDEX (taind) where au_id > 1 and title_id = 'PS3333' */
...
alter table publishers add constraint pubid_rule
	CHECK 
	(pub_id in ("1389", "0736", "0877", "1622", "1756") OR
	pub_id like "99[0-9][0-9]");

alter table titles add constraint titleid_rule 
	CHECK 
...
alter table salesdetail add constraint titleid_rule CHECK (title_id like "BU[0-9][0-9][0-9][0-9]" or
     @title_id like "[MT]C[0-9][0-9][0-9][0-9]" or
     @title_id like "P[SC][0-9][0-9][0-9][0-9]" or
     @title_id like "[A-Z][A-Z]xxxx" or
      @title_id like "[A-Z][A-Z]yyyy");
...
SELECT * FROM titleview where title = 'The Busy Executive''s Database Guide';

create view authorview as
	select au_fname, au_lname, address , city, state, postalcode, country
	from authors;
	
/* create stored procedures 
-- note that you have to set a new delimiter then unset it so as not to confuse mysql */
